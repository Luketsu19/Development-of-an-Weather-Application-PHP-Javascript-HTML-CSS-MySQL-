    ...
    <div class="container">
        ...
        if ($actions == 'pas encore d\'actions') {
            ...
            foreach ($actions as $action) {
                echo "<tr>";
                echo "<td>" . htmlspecialchars($action["id_utilisateur"]) . "</td>";
                echo "<td>" . htmlspecialchars($action["action"]) . "</td>";
                echo "<td>" . htmlspecialchars($action["details_action"]) . "</td>";
                echo "<td>" . htmlspecialchars($action["date"]) . "</td>";
                echo "<td>
                    <a href='http://localhost/sae/web/frontcontroller.php?controller=controller&action=deleteaction&id=" . htmlspecialchars($action["id_action"]) . "'>Supprimer</a>
                </td>";
                echo "</tr>";
            }
            echo "</tbody>
