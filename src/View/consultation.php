...
<div id="infoBox" class="info-box">Année : / Période :</div>
    ...
    function displayGroup(groupIndex) {
        ...
        if (groupIndex < dataGroups.length) {
			...
			if (granularity === "mois") {
				...
				document.getElementById('infoBox').textContent = `Année : ${annee} / Mois : ${mois} (${periode})`;
			} else if (granularity === "semaine") {
				document.getElementById('infoBox').textContent = `Année : ${annee} / Semaine : ${periode}`;
			} else if (granularity === "annee") {
				document.getElementById('infoBox').textContent = `Année : ${annee}`;
			} else {
				document.getElementById('infoBox').textContent = `Année : ${annee} / Jour : ${periode}`;
			}
